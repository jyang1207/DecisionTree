...
def main(argv):
	...
	trainclass = classifiers.DecisionTreeClassifier(train, train.get_headers(), traincat)
	print 'classifying training data'
	predtraincats = trainclass.classify(train.get_data(train.get_headers()))
	
	print 'making testing data'
	testclass = classifiers.DecisionTreeClassifier(test, test.get_headers(), testcat)
